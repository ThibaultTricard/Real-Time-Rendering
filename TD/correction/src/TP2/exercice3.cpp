...
int main() {
...

    {
        ...
        // 8 sommets, couleurs style RGB (chaque coin = combinaison RGB)
        ...
        projection[1][1] *= -1.0f; // Correction de l'axe Y Vulkan
        ...
        // ---- Pipeline graphique avec depth test ----
        LavaCake::GraphicsPipeline pipeline =
            LavaCake::GraphicsPipeline::Builder(device)
                .addShaderFromFile(root + "shaders/TP2/cube.vert",
