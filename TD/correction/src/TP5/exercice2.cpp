...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(800, 600, "TP5 - Displacement Mapping", nullptr, nullptr);
...

    {
        ...
        if (!loadModel(root + "../sujets/models/sphere_high_poly.obj", root + "models/",
        ...
        // ---- Textures ----
        TextureData heightData = loadTexture(root + "../sujets/models/Sphere_height_map.png");
        LavaCake::Image     heighTex(device, heightData.pixels, heightData.width, heightData.height, 1,
                                       vk::Format::eR8G8B8A8Srgb, vk::ImageUsageFlagBits::eSampled);
        LavaCake::ImageView heightView(heighTex);
        LavaCake::Sampler   heightSampler(device, vk::SamplerMipmapMode::eLinear, 0.0f, 0.0f);
        ...
        LavaCake::DescriptorSetLayout layout =
            LavaCake::DescriptorSetLayout::Builder(device)
                ...
                .addCombinedImageSampler(9,  vk::ShaderStageFlagBits::eVertex)
                .addCombinedImageSampler(10,  vk::ShaderStageFlagBits::eFragment)
                .build();
        ...
        LavaCake::DescriptorSetUpdater(device, descriptorSet)
            ...
            .bindImage(9, heightView,  heightSampler)
            .bindImage(10, normalView,  normalSampler)
            .update();
        ...
        LavaCake::GraphicsPipeline pipeline =
            LavaCake::GraphicsPipeline::Builder(device)
                .addShaderFromFile(root + "shaders/TP5/displacement.vert",
                                   vk::ShaderStageFlagBits::eVertex,
                                   LavaCake::ShadingLanguage::eGLSL)
                .addShaderFromFile(root + "shaders/TP5/displacement.frag",
